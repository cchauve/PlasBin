...
def contig_vars(m, contigs_dict, contigs, degree, contigs_ext, ceil):
	for p in range(1):
		contigs[p] = {}
		degree[p] = {}
		contigs_ext[p] = {}
...
def GC_vars(m, contigs_dict, mean_GC, counted_GC_mean, GC_diff, counted_GC_diff):
	for p in range(1):
		mean_GC[p] = {}
		counted_GC_mean[p] = {}
		GC_diff[p] = {}
...
def ln_vars(m, contigs_dict, counted_ln):
	for p in range(1):
		counted_ln[p] = {}	
		for c in contigs_dict:
