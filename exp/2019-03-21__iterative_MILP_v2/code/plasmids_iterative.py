...
output_dir = '/home/aniket/python_scripts/Plasmids/exp/2019-03-21__iterative_with_questionable/output/' 
...
questionable = 'questionable_plasmids.fasta'
...
questionable_file = open(os.path.join(output_folder, questionable), "w")
