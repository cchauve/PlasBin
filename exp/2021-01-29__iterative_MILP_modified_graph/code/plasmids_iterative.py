...
#sample_dir = '/home/aniket/python_scripts/Plasmids-Optimization/exp/2021-01-29__iterative_MILP_modified_graph/test_examples/' 
#output_dir = '/home/aniket/python_scripts/Plasmids-Optimization/exp/2021-01-29__iterative_MILP_modified_graph/test_output/' 
...
seeds_set = set()
rd_dict = {}
contigs_dict, links_list, rd_dict = plasmids_preprocessing.get_data(assembly_file, contigs_dict, links_list, rd_dict)
...
#while iter_count <= 1:
	...
	#Constraint type 12
	#Ratio of contig length to total plasmid length	
